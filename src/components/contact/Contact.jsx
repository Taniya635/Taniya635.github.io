    ...
    <section id='contact'>
      ...
      <div className='container contact_container'>
        <div className='contact-options'>
          ...
          <h4>Email</h4>
          <h5>taniyamaurya09@gmail.com</h5>
          <a href="mailto:taniyamaurya09@gmail.com" target='_blank'>Send a message</a>
          </article>
          ...
          <h4>WhatsApp</h4>
          <h5>+91 7039471042</h5>
          <a href="https://api.whatsapp.com/send?phone=7039471042" target='_blank'>Send a message</a>
          </article>
